...
(function (global, factory) {
      ...
      var schedule = set$1(this, id),
        ...
        listener =
          schedule.value[key] == null
            ? remove || (remove = styleRemove$1(name))
            : undefined;
  ...
  function transition_style(name, value, priority) {
    ...
    return value == null
      ...
      : this.styleTween(name, styleConstant$1(name, i, value), priority).on(
          "end.style." + name,
          null
        );
  }
  ...
  function brush$1(dim) {
    ...
    function started(event) {
      ...
      function move(event) {
        ...
        switch (mode) {
          ...
          case MODE_DRAG: {
            if (signX)
              (dx = max$1(W - w0, min$1(E - e0, dx))),
                (w1 = w0 + dx),
                (e1 = e0 + dx);
            if (signY)
              (dy = max$1(N - n0, min$1(S - s0, dy))),
                (n1 = n0 + dy),
                (s1 = s0 + dy);
            break;
          }
          case MODE_HANDLE: {
            if (points[1]) {
              if (signX)
                (w1 = max$1(W, min$1(E, points[0][0]))),
                  (e1 = max$1(W, min$1(E, points[1][0]))),
                  (signX = 1);
              if (signY)
                (n1 = max$1(N, min$1(S, points[0][1]))),
                  (s1 = max$1(N, min$1(S, points[1][1]))),
                  (signY = 1);
            } else {
              if (signX < 0)
                (dx = max$1(W - w0, min$1(E - w0, dx))),
                  (w1 = w0 + dx),
                  (e1 = e0);
              else if (signX > 0)
                (dx = max$1(W - e0, min$1(E - e0, dx))),
                  (w1 = w0),
                  (e1 = e0 + dx);
              if (signY < 0)
                (dy = max$1(N - n0, min$1(S - n0, dy))),
                  (n1 = n0 + dy),
                  (s1 = s0);
              else if (signY > 0)
                (dy = max$1(N - s0, min$1(S - s0, dy))),
                  (n1 = n0),
                  (s1 = s0 + dy);
            }
            break;
          ...
          case MODE_CENTER: {
            if (signX)
              (w1 = max$1(W, min$1(E, w0 - dx * signX))),
                (e1 = max$1(W, min$1(E, e0 + dx * signX)));
            if (signY)
              (n1 = max$1(N, min$1(S, n0 - dy * signY))),
                (s1 = max$1(N, min$1(S, s0 + dy * signY)));
            break;
          }
        }
    ...
    brush.extent = function (_) {
      return arguments.length
        ? ((extent = typeof _ === "function" ? _ : constant$4(number2(_))),
          brush)
        : extent;
    };
    ...
    brush.touchable = function (_) {
      return arguments.length
        ? ((touchable = typeof _ === "function" ? _ : constant$4(!!_)), brush)
        : touchable;
    };
  ...
  function ribbon(headRadius) {
    ...
    function ribbon() {
      ...
      if (ap > epsilon$1) {
        if (abs$1(sa1 - sa0) > ap * 2 + epsilon$1)
          sa1 > sa0 ? ((sa0 += ap), (sa1 -= ap)) : ((sa0 -= ap), (sa1 += ap));
        else sa0 = sa1 = (sa0 + sa1) / 2;
        if (abs$1(ta1 - ta0) > ap * 2 + epsilon$1)
    ...
    if (headRadius)
      ribbon.headRadius = function (_) {
        return arguments.length
          ? ((headRadius = typeof _ === "function" ? _ : constant$5(+_)),
            ribbon)
          : headRadius;
      };
    ...
    ribbon.radius = function (_) {
      return arguments.length
        ? ((sourceRadius = targetRadius =
            typeof _ === "function" ? _ : constant$5(+_)),
          ribbon)
        : sourceRadius;
    };
    ...
    ribbon.sourceRadius = function (_) {
      return arguments.length
        ? ((sourceRadius = typeof _ === "function" ? _ : constant$5(+_)),
          ribbon)
        : sourceRadius;
    };
    ...
    ribbon.targetRadius = function (_) {
      return arguments.length
        ? ((targetRadius = typeof _ === "function" ? _ : constant$5(+_)),
          ribbon)
        : targetRadius;
    };
    ...
    ribbon.padAngle = function (_) {
      return arguments.length
        ? ((padAngle = typeof _ === "function" ? _ : constant$5(+_)), ribbon)
        : padAngle;
    };
    ...
    function initialize() {
      ...
      for (i = 0, count = new Array(n); i < m; ++i) {
        ...
        if (typeof link.source !== "object")
          link.source = find$1(nodeById, link.source);
        if (typeof link.target !== "object")
          link.target = find$1(nodeById, link.target);
  ...
  function boundsRingPoint(lambda, phi) {
    if (p0) {
      var delta = lambda - lambda2;
      deltaSum.add(
        abs$2(delta) > 180 ? delta + (delta > 0 ? 360 : -360) : delta
      );
    } else {
  ...
  function rotationIdentity(lambda, phi) {
    return [
      abs$2(lambda) > pi$3
        ? lambda + Math.round(-lambda / tau$4) * tau$4
        : lambda,
      phi,
    ];
  }
  ...
  function rotation(rotate) {
    ...
    function forward(coordinates) {
      ...
      return (
        (coordinates[0] *= degrees$2),
        (coordinates[1] *= degrees$2),
        coordinates
      );
    }
  ...
  function polygonContains(polygon, point) {
    ...
    return (
      (angle < -epsilon$4 || (angle < epsilon$4 && sum < -epsilon2$1)) ^
      (winding & 1)
    );
  }
    ...
    function intersect(a, b, two) {
      ...
      if (
        meridian
          ? polar
            ? (phi0 + phi1 > 0) ^
              (q[1] < (abs$2(q[0] - lambda0) < epsilon$4 ? phi0 : phi1))
            : phi0 <= q[1] && q[1] <= phi1
    ...
    function resampleLineTo(
      ...
      if (d2 > 4 * delta2 && depth--) {
        var a = a0 + a1,
          ...
          phi2 = asin((c /= m)),
          lambda2 =
            abs$2(abs$2(c) - 1) < epsilon$4 ||
            abs$2(lambda0 - lambda1) < epsilon$4
              ? (lambda0 + lambda1) / 2
              : atan2(b, a),
  ...
  function transformer$1() {
    ...
    scale.domain = function (_) {
      return arguments.length
        ? ((domain = Array.from(_, number$2)), rescale())
        : domain.slice();
    };
    ...
    scale.clamp = function (_) {
      return arguments.length
        ? ((clamp = _ ? true : identity$6), rescale())
        : clamp !== identity$6;
    };
  ...
  function identity$7(domain) {
    ...
    scale.domain = scale.range = function (_) {
      return arguments.length
        ? ((domain = Array.from(_, number$2)), scale)
        : domain.slice();
    };
  ...
  function radial$1() {
    ...
    scale.range = function (_) {
      return arguments.length
        ? (squared.range((range = Array.from(_, number$2)).map(square)), scale)
        : range.slice();
    };
  ...
  function line(x, y) {
    ...
    line.x = function (_) {
      return arguments.length
        ? ((x = typeof _ === "function" ? _ : constant$b(+_)), line)
        : x;
    };

    line.y = function (_) {
      return arguments.length
        ? ((y = typeof _ === "function" ? _ : constant$b(+_)), line)
        : y;
    };
  ...
  function area$3(x0, y0, y1) {
    ...
    x0 =
      typeof x0 === "function" ? x0 : x0 === undefined ? x$3 : constant$b(+x0);
    y0 =
      typeof y0 === "function"
        ? y0
        : y0 === undefined
        ...
        : constant$b(+y0);
    y1 =
      typeof y1 === "function" ? y1 : y1 === undefined ? y$3 : constant$b(+y1);
  ...
  function pie() {
    ...
    function pie(data) {
      var i,
        ...
        da = Math.min(
          tau$5,
          Math.max(-tau$5, endAngle.apply(this, arguments) - a0)
        ),
        a1,
  ...
  function link$2(curve) {
    ...
    link.x = function (_) {
      return arguments.length
        ? ((x = typeof _ === "function" ? _ : constant$b(+_)), link)
        : x;
    };

    link.y = function (_) {
      return arguments.length
        ? ((y = typeof _ === "function" ? _ : constant$b(+_)), link)
        : y;
    };
  ...
  function symbol(type, size) {
    ...
    size =
      typeof size === "function"
        ? size
        : constant$b(size === undefined ? 64 : +size);
  ...
  function stack() {
    ...
    stack.keys = function (_) {
      return arguments.length
        ? ((keys = typeof _ === "function" ? _ : constant$b(Array.from(_))),
          stack)
        : keys;
    };
  ...
  function zoom() {
    ...
    zoom.wheelDelta = function (_) {
      return arguments.length
        ? ((wheelDelta = typeof _ === "function" ? _ : constant$c(+_)), zoom)
        : wheelDelta;
    };

    zoom.filter = function (_) {
      return arguments.length
        ? ((filter = typeof _ === "function" ? _ : constant$c(!!_)), zoom)
        : filter;
    };

    zoom.touchable = function (_) {
      return arguments.length
        ? ((touchable = typeof _ === "function" ? _ : constant$c(!!_)), zoom)
        : touchable;
    };
